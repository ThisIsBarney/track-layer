// language=GLSL
export default `
#define SHADER_NAME track-layer-vertex-shader
...
void main() {
  ...
  vec3 prevPosition = mix(-instanceLeftDeltas, vec3(0.0), isEnd) + startPos;
  ...
  vec3 nextPosition = mix(vec3(0.0, 0.0, 0.1), instanceRightDeltas, isEnd) + endPos;
